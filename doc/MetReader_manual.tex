...
\item \texttt{idf} :: Data file format code (ascii, netcdf, grib, etc)
 ...
 %\item   5 : HDF (Not implemented; used by older NASA MERRA)
 \end{itemize}
...
%3-d ASCII input files was originally designed around a particular tool for
%converting netcdf forecast files to ASCII.  This input format
%( \texttt{MR\_iwind=2} and \texttt{MR\_iwindformat=1}) has since been
%depreciated until a more general input format can be designed.
...
The next section shows several examples of these template files used with NAM and GFS
forecast products.

\begin{figure}[htbp]\begin{center}
 \includegraphics[angle=-90,scale=1.0]{Figs/Overview_NCEP-Grids.pdf}
